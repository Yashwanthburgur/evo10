                ...
                <div className="bg-white py-8 px-4 shadow-xl rounded-xl sm:px-10">
                    <div className="mb-6">
                        <div className="flex border-b border-gray-200">
                            <button onClick={() => setIsVendor(false)} className={`w-1/2 py-4 text-center font-medium transition-colors ${!isVendor ? 'text-indigo-600 border-b-2 border-indigo-500' : 'text-gray-500 hover:text-gray-700'}`}>
                                I'm a Customer
                            </button>
                            <button onClick={() => setIsVendor(true)} className={`w-1/2 py-4 text-center font-medium transition-colors ${isVendor ? 'text-indigo-600 border-b-2 border-indigo-500' : 'text-gray-500 hover:text-gray-700'}`}>
                                I'm a Vendor
                            </button>
                        </div>
                    </div>
